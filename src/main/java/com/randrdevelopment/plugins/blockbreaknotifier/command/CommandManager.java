package com.randrdevelopment.plugins.blockbreaknotifier.command;
...
public class CommandManager {
	...
	public boolean dispatch(CommandSender sender, Command command, String label, String[] args, BlockBreakNotifier plugin) {
        String input = label + " ";
        for (String s : args) {
            input += s + " ";
        }
